// src/components/GruppeC.tsx
import { useContext, useEffect } from "react";
import { ResultsContext, MatchResult } from "../contexts/ResultsContext";

const teamsData = [
  { code: "DEN", land: "Dänemark" },
  { code: "GRE", land: "Griechenland" },
  { code: "SCO", land: "Schottland" },
  { code: "BLR", land: "Belarus" },
];

const initialSpiele: MatchResult[] = [
  { spieltag: 1, datum: "05.09.2025", heim: "GRE", auswärts: "BLR", homeGoals: "", awayGoals: "" },
  { spieltag: 1, datum: "05.09.2025", heim: "DEN", auswärts: "SCO", homeGoals: "", awayGoals: "" },
  { spieltag: 2, datum: "08.09.2025", heim: "BLR", auswärts: "SCO", homeGoals: "", awayGoals: "" },
  { spieltag: 2, datum: "08.09.2025", heim: "GRE", auswärts: "DEN", homeGoals: "", awayGoals: "" },
  { spieltag: 3, datum: "09.10.2025", heim: "BLR", auswärts: "DEN", homeGoals: "", awayGoals: "" },
  { spieltag: 3, datum: "09.10.2025", heim: "SCO", auswärts: "GRE", homeGoals: "", awayGoals: "" },
  { spieltag: 4, datum: "12.10.2025", heim: "SCO", auswärts: "BLR", homeGoals: "", awayGoals: "" },
  { spieltag: 4, datum: "12.10.2025", heim: "DEN", auswärts: "GRE", homeGoals: "", awayGoals: "" },
  { spieltag: 5, datum: "15.11.2025", heim: "GRE", auswärts: "SCO", homeGoals: "", awayGoals: "" },
  { spieltag: 5, datum: "15.11.2025", heim: "DEN", auswärts: "BLR", homeGoals: "", awayGoals: "" },
  { spieltag: 6, datum: "18.11.2025", heim: "BLR", auswärts: "GRE", homeGoals: "", awayGoals: "" },
  { spieltag: 6, datum: "18.11.2025", heim: "SCO", auswärts: "DEN", homeGoals: "", awayGoals: "" },
];

const flagge = (code: string) => `/flags/${code.toLowerCase()}.svg`;
const landName = (code: string) => teamsData.find(t => t.code === code)?.land || code;

export default function GruppeC() {
  const { results, setResults } = useContext(ResultsContext);

  useEffect(() => {
    if (!results["C"]) {
      setResults(r => ({ ...r, C: initialSpiele }));
    }
  }, [results, setResults]);

  const spiele = results["C"] ?? initialSpiele;
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <h2 className="text-2xl font-bold">🌍 WM-Quali 2026 – Gruppe C</h2>
