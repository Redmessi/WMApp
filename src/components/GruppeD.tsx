// src/components/GruppeD.tsx
import { useContext, useEffect } from "react";
import { ResultsContext, MatchResult } from "../contexts/ResultsContext";

const teamsData = [
  { code: "FRA", land: "Frankreich" },
  { code: "UKR", land: "Ukraine" },
  { code: "ISL", land: "Island" },
  { code: "AZE", land: "Aserbaidschan" },
];

const initialSpiele: MatchResult[] = [
  { spieltag: 1, datum: "05.09.2025", heim: "ISL", auswärts: "AZE", homeGoals: "", awayGoals: "" },
  { spieltag: 1, datum: "05.09.2025", heim: "UKR", auswärts: "FRA", homeGoals: "", awayGoals: "" },
  { spieltag: 2, datum: "09.09.2025", heim: "AZE", auswärts: "UKR", homeGoals: "", awayGoals: "" },
  { spieltag: 2, datum: "09.09.2025", heim: "FRA", auswärts: "ISL", homeGoals: "", awayGoals: "" },
  { spieltag: 3, datum: "10.10.2025", heim: "ISL", auswärts: "UKR", homeGoals: "", awayGoals: "" },
  { spieltag: 3, datum: "10.10.2025", heim: "FRA", auswärts: "AZE", homeGoals: "", awayGoals: "" },
  { spieltag: 4, datum: "13.10.2025", heim: "ISL", auswärts: "FRA", homeGoals: "", awayGoals: "" },
  { spieltag: 4, datum: "13.10.2025", heim: "UKR", auswärts: "AZE", homeGoals: "", awayGoals: "" },
  { spieltag: 5, datum: "15.11.2025", heim: "AZE", auswärts: "ISL", homeGoals: "", awayGoals: "" },
  { spieltag: 5, datum: "15.11.2025", heim: "FRA", auswärts: "UKR", homeGoals: "", awayGoals: "" },
  { spieltag: 6, datum: "16.11.2025", heim: "AZE", auswärts: "FRA", homeGoals: "", awayGoals: "" },
  { spieltag: 6, datum: "16.11.2025", heim: "UKR", auswärts: "ISL", homeGoals: "", awayGoals: "" },
];

const flagge = (code: string) => `/flags/${code.toLowerCase()}.svg`;
const landName = (code: string) => teamsData.find(t => t.code === code)?.land || code;

export default function GruppeD() {
  const { results, setResults } = useContext(ResultsContext);

  useEffect(() => {
    if (!results["D"]) {
      setResults(r => ({ ...r, D: initialSpiele }));
    }
  }, [results, setResults]);

  const spiele = results["D"] ?? initialSpiele;
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <h2 className="text-2xl font-bold">🌍 WM-Quali 2026 – Gruppe D</h2>
