// src/components/GruppeH.tsx
import { useContext, useEffect } from 'react';
import { ResultsContext, MatchResult } from "../contexts/ResultsContext";

const teamsData = [
  { code: 'AUT', land: 'Österreich' },
  { code: 'ROU', land: 'Rumänien' },
  { code: 'BIH', land: 'Bosnien und Herzegowina' },
  { code: 'CYP', land: 'Republik Zypern' },
  { code: 'SMR', land: 'San Marino' },
];

const initialSpiele: MatchResult[] = [
  { spieltag: 1, datum: '21.03.2025', heim: 'CYP', auswärts: 'SMR', homeGoals: '', awayGoals: '' },
  { spieltag: 1, datum: '21.03.2025', heim: 'ROU', auswärts: 'BIH', homeGoals: '', awayGoals: '' },
  { spieltag: 2, datum: '24.03.2025', heim: 'BIH', auswärts: 'CYP', homeGoals: '', awayGoals: '' },
  { spieltag: 2, datum: '24.03.2025', heim: 'SMR', auswärts: 'ROU', homeGoals: '', awayGoals: '' },
  { spieltag: 3, datum: '07.06.2025', heim: 'BIH', auswärts: 'SMR', homeGoals: '', awayGoals: '' },
  { spieltag: 3, datum: '07.06.2025', heim: 'AUT', auswärts: 'ROU', homeGoals: '', awayGoals: '' },
  { spieltag: 4, datum: '10.06.2025', heim: 'ROU', auswärts: 'CYP', homeGoals: '', awayGoals: '' },
  { spieltag: 4, datum: '10.06.2025', heim: 'SMR', auswärts: 'AUT', homeGoals: '', awayGoals: '' },
  { spieltag: 5, datum: '06.09.2025', heim: 'AUT', auswärts: 'CYP', homeGoals: '', awayGoals: '' },
  { spieltag: 5, datum: '06.09.2025', heim: 'SMR', auswärts: 'BIH', homeGoals: '', awayGoals: '' },
  { spieltag: 6, datum: '09.09.2025', heim: 'BIH', auswärts: 'AUT', homeGoals: '', awayGoals: '' },
  { spieltag: 6, datum: '09.09.2025', heim: 'CYP', auswärts: 'ROU', homeGoals: '', awayGoals: '' },
  { spieltag: 7, datum: '09.10.2025', heim: 'AUT', auswärts: 'SMR', homeGoals: '', awayGoals: '' },
  { spieltag: 7, datum: '09.10.2025', heim: 'CYP', auswärts: 'BIH', homeGoals: '', awayGoals: '' },
  { spieltag: 8, datum: '12.10.2025', heim: 'SMR', auswärts: 'CYP', homeGoals: '', awayGoals: '' },
  { spieltag: 8, datum: '12.10.2025', heim: 'ROU', auswärts: 'AUT', homeGoals: '', awayGoals: '' },
  { spieltag: 9, datum: '15.11.2025', heim: 'CYP', auswärts: 'AUT', homeGoals: '', awayGoals: '' },
  { spieltag: 9, datum: '15.11.2025', heim: 'BIH', auswärts: 'ROU', homeGoals: '', awayGoals: '' },
  { spieltag: 10, datum: '18.11.2025', heim: 'AUT', auswärts: 'BIH', homeGoals: '', awayGoals: '' },
  { spieltag: 10, datum: '18.11.2025', heim: 'ROU', auswärts: 'SMR', homeGoals: '', awayGoals: '' },
];

const flagge = (code: string) => `/flags/${code.toLowerCase()}.svg`;
const landName = (code: string) => teamsData.find(t => t.code === code)?.land || code;

export default function GruppeH() {
  const { results, setResults } = useContext(ResultsContext);

  useEffect(() => {
    if (!results["H"]) {
      setResults(r => ({ ...r, H: initialSpiele }));
    }
  }, [results, setResults]);

  const spiele = results["H"] ?? initialSpiele;

  const updateGoals = (idx: number, field: "homeGoals" | "awayGoals", value: string) => {
    setResults(r => {
      const group = [...(r["H"] ?? initialSpiele)];
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <h2 className="text-2xl font-bold">🌍 WM-Quali 2026 – Gruppe H</h2>
