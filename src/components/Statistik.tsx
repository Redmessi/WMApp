  ...
  return (
    <div>
      ...
      <button
        ...
        className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-2 rounded mb-8"
      >
        Simulation starten
      </button>
      <button
        onClick={exportTableAsImage}
        className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-2 rounded mb-8 ml-2"
      >
        Tabelle speichern
      </button>
      {Object.keys(simulatedData).length > 0 && (
        <div className="mb-8">
          <div id="table-container">
            <table className="table-auto mb-7" style={{ maxWidth: "800px" }}>
              <thead>
                <tr>
                  <th className="px-1 py-">Team</th>
                  {teamCodes.map((_, idx) => (
